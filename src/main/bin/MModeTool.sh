...
#It is stored at git://github.com/EBIBioSamples/TagControl.git/src/main/bin
#and installed by http://coconut.ebi.ac.uk:8085/browse/BSD-TAG
...
$java $args -classpath $classpath uk.ac.ebi.age.tagcontrol.TagControl $@
